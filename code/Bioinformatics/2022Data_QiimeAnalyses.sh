...
qiime demux summarize \
  --i-data 16S-SAB-combined-demux.qza \
  --o-visualization 16S-SAB-demux-subsample.qzv ##save tsv file of per-sample-fastq-counts.tsv for optional step below ##
...
--i-demultiplexed-seqs 16S-SAB-combined-demux.qza  \
--p-trunc-len-f  125 \
--p-trunc-len-r  125 \
--p-n-threads 0 \
